...
* Make sure to get the API using `skinsRestorerAPI = SkinsRestorerProvider.get()` and define by
...
Channel*](https://www.spigotmc.org/wiki/bukkit-bungee-plugin-messaging-channel/) to send the commands to BungeeCord.
