...
You can find the Skinfile Generator on [our domain](https://generator.skinsrestorer.net).

<Callout type="warning" emoji="⚠️">
    The Skinfile Generator only works if you use file storage. MySQL users should use the `/sr createcustom` command.
</Callout>

It's also [open-source](https://github.com/SkinsRestorer/SkinFile-Generator),
so you can host it yourself if you want to.

Steps to generate a custom skin using the Skinfile Generator:

1. Get your skin file in .png format
2. Go to the website (https://generator.skinsrestorer.net)
