...
<Cards>
    <Card
        ...
        href="/docs/installation/install-bukkit"
    >
    </Card>
    <Card
        icon={
            <Image
                src="/platform/bungee.png"
                alt="BungeeCord"
                width={24}
                height={24}/>
        }
        title="BungeeCord"
        href="/docs/installation/install-bungee"
    >
    </Card>
    <Card
        icon={
        ...
        title="Sponge"
        href="/docs/installation/install-sponge"
    >
    </Card>
    <Card
        icon={
        ...
        title="Velocity"
        href="/docs/installation/install-velocity"
    >
    </Card>
</Cards>
