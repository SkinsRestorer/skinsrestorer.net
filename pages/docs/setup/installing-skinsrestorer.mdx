...
<Tabs items={['Spigot', 'BungeeCord', 'Sponge', 'Velocity']}>
    <Tab>
        <Callout type="info" emoji="ℹ️">
            If you're using BungeeCord/Velocity (or any other proxy system), you must follow the [BungeeCord](#installing-Bungee) installation process.
        </Callout>

        1. Download the latest version from [SpigotMC](https://www.spigotmc.org/resources/skinsrestorer.2124/)
