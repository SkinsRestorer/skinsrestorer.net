...
We have our own Crowdin page at [translate.skinsrestorer.net](https://translate.skinsrestorer.net) where you can contribute.

If a language is missing, you can contact support on our discord.

## How to update

You can download updated translations from our [`dev` branch](https://github.com/SkinsRestorer/SkinsRestorerX/tree/dev/shared/src/main/resources/languages).
