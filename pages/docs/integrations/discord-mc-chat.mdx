...
<Steps>
    ### Prepare your server
    Ensure [SkinsRestorer](/docs/installation), [Discord-MC-Chat](https://modrinth.com/mod/discord-mc-chat) are installed on your server, are the latest version and are working correctly.
