    ...
    <main className="w-full min-w-0 max-w-6xl px-6 pt-4 md:px-12">
        <div className="mx-auto container">
            ...
            <div className="p-4 flex flex-col">
                <div className="mt-8 md:mt-32 flex flex-col md:flex-row mx-auto gap-2">
                    <Image src="/logo.png" width={128} height={128} className="w-24 md:w-16 h-24 md:h-16 mx-auto" alt="SkinsRestorer Logo"/>
