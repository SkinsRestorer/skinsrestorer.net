            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-row">
                    ...
                    <a
                        ...
                        <Image className="rounded-full w-6 h-6 my-auto mx-1" src={latest.author.avatar} width={16}
                               height={16}/>
    ...
    <main className="w-full min-w-0 max-w-6xl px-6 pt-4 md:px-12">
        <div className="mx-auto container">
            ...
            <div className="p-4 flex flex-col">
                <div className="mt-32 flex flex-row mx-auto gap-2">
                    <Image src="/logo.png" width={128} height={128} className="w-16 h-16" alt="SkinsRestorer Logo"/>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-16">
                    ...
                    <FeatureCard
                        title="Use our GUI"
                        description={<span>SkinsRestorer has a GUI to change your skin, just run <code className="highlight-code">/skins</code>!</span>}
