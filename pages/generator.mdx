        ...
        <div
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid w-full max-w-sm items-center gap-1.5">
                    ...
                    <Select id="skin-type" value={skinType} onValueChange={value => {
                        setSkinType(value)
                    }}>
                ...
                <Button onClick={() => {
                    ...
                    if (customName && !/^[a-zA-Z0-9_]+$/.test(customName)) {
                        toast.warning("Invalid skin name. Skin name can only contain letters, numbers and underscores. (a-zA-Z0-9_)")
                        return
                    }
        ...
        <div
            ...
            <div className="flex flex-col gap-4">
                <div className="grid w-full max-w-sm items-center gap-1.5">
                    ...
                    <Input id="skin-file" type="file" accept=".playerskin,.urlskin,.customskin,.legacyskin"
                           onChange={(e) => {
