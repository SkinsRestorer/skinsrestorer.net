---
title: Firewall
description: Permit the network connections that SkinsRestorer requires.
icon: Shield
---
...
This message means that the server cannot connect to an API that SkinsRestorer requires.

## Permit the required connections

<Callout type="info" emoji="ℹ️">
  This list can change.
  If the problem returns, compare your firewall rules with this page.
</Callout>
...
Permit outgoing connections to port `53` on your DNS server.
