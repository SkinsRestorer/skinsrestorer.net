...
description: Use logs and debug tools to find SkinsRestorer problems.
icon: Bug
---
...
<Callout type="warning">
  CAUTION: Debug mode writes many log messages.
  Enable it only while you collect information. Then disable it.
</Callout>
...
If an endpoint is unavailable, use the [firewall guide](/docs/troubleshooting/firewall).
...
```
This warning means that old `.txt` configuration files exist.
