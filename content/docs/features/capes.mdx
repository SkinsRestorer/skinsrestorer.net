---
title: Cape Support
description: Understand which capes SkinsRestorer can show.
icon: Crown
---
...
<Callout type="info">
  You cannot create a custom cape or move a cape to another account.
  Each cape belongs to a Mojang or Microsoft account.
</Callout>

## How SkinsRestorer handles capes

When you use `/skin <playerName>`, SkinsRestorer gets the complete skin data from Mojang.
The data contains:
...
The cape URL exists only when the player equips a cape.
Mojang signs the complete data. Therefore, SkinsRestorer cannot create custom capes.
