...
<Callout type="info" emoji="ℹ️">
  If you want to set a skin of a player on your server, run `/skin [name]
  [playername]` instead. Using custom skins to set a skin of a player is not
...
<Callout type="warning" emoji="⚠️">
  The Skinfile Generator only works if you use file storage. MySQL users should
  use the `/sr createcustom` command.
</Callout>
