...
<Callout type="warning">
  MineSkin only generates skin textures. It cannot generate capes, as capes require specific Mojang account verification and cannot be created arbitrarily. See the [Cape Support](/docs/features/capes) page for details.
</Callout>
