...
<Cards>
  ...
  <Card
    ...
    title="NeoForge"
    href="/docs/installation/neoforge"
  ></Card>
</Cards>

<Callout type="warning" emoji="🆕">
  The Fabric and NeoForge mod releases of SkinsRestorer currently support **only the latest Minecraft version**. They
  provide the same features as the Bukkit plugin when used on that supported release.
</Callout>
