...
Use these guides to install SkinsRestorer for the first time.
...
Select your server or proxy platform.
...
<Callout type="warning" emoji="🆕">
  ...
  On that version, they provide the same features as the Bukkit plugin.
</Callout>
