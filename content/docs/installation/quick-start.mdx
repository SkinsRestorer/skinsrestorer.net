...
description: Install SkinsRestorer on a single server or proxy network.
icon: Zap
---
...
<Tabs items={['Single Server', 'Small Network (2-5 servers)', 'Large Network (5+ servers)']}>
  ...
  <Tab>
    ...
    **Test the network:**
    ...
    - Run `/skin Notch`.
    - Switch to another server. The skin must stay active.
  ...
  <Tab>
    ...
    **Backend server configuration:**
    ...
    - One shared skin database
    - API access on all servers
    - Better performance for large networks
    - Skin access for plugins such as BedWars and Dynmap
  </Tab>
</Tabs>
